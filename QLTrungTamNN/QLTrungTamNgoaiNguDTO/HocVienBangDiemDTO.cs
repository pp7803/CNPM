...
{
    internal class HocVienBangDiemDTO
    {
        ...
        private float diem;
        public HocVienBangDiemDTO()
        {
        }

        public HocVienBangDiemDTO(string maHocVien, string ho, string ten, DateTime ngaySinh, int gioiTinh, string diaChi, string email, DateTime ngayGiaNhap, int trangthai, float diem)
        {
